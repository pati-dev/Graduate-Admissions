...
```{r}
ggplot(inter.small, aes(x = Q39, ..count.., fill = likelihood)) + geom_density(position = "fill") + ggtitle("Likelihood of staying in the US after graduation") + scale_fill_manual(values = cb_palette)
```
